          ...
          */}
          ...
          <div className="fixed inset-0 z-[60] flex flex-col items-center justify-end md:justify-center pointer-events-none">
            <motion.div
              ...
              style={{ maxHeight: 'calc(100dvh - 7rem - var(--pwa-safe-bottom))' }}
              className="liquid-glass pointer-events-auto mx-3 mb-[calc(var(--pwa-safe-bottom)+5rem)] flex w-[min(420px,calc(100vw-24px))] flex-col overflow-hidden rounded-[var(--radius-xl)] md:mb-0 md:rounded-[var(--radius-lg)]"
            >
