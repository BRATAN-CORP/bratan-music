            ...
            {albums.map((album) => (
              ...
              >
                <div className="relative aspect-square overflow-hidden rounded-[var(--radius-md)] border border-border bg-secondary/60">
                  {album.coverUrl ? (
                    <img src={album.coverUrl} alt={album.title} className="h-full w-full object-cover transition-transform group-hover:scale-105" />
                  ) : (
            ...
            {playlists.map((pl) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {pl.trackIds.length} {pl.trackIds.length === 1 ? t('library.trackUnit1') : t('library.trackUnit5plus')}
                  </p>
                </div>
              </Link>
            ))}
